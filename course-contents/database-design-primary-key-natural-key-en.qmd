...
For example, let's assume that TcIdentityNo is selected as the primary key in Table @tbl-table-primary-key-natural-key-example-person-table. 
...
: Natural Key Example 2 - Person Table {#tbl-table-primary-key-natural-key-example-person-table.}
