...
CREATE OR REPLACE PROCEDURE Create_Employee (firstname IN varchar2,lastname IN varchar2 , id OUT number)
IS
BEGIN
  INSERT INTO CHINOOK."Employee" ( "LastName", "FirstName") VALUES(firstname,lastname) returning "EmployeeId" into id;   
END;
