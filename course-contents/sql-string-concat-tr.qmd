...
SQL dilinde betik tanımı **''** karakterleri arasında istenilen karakterlerin yazımı ile yapılır.
...
:::{.callout-tip}
Eğer veritabanı bağımsız SQL yazmanız gerekiyorsa CONCAT fonksiyonunu tercih ediniz.
:::
