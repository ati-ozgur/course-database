...
SQL server has CONCAT_WS function.


- [oracle documentation for function](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/CONCAT.html)
- [SQL Server documentation for function](https://learn.microsoft.com/en-us/sql/t-sql/functions/concat-ws-transact-sql?view=sql-server-ver16)
...
- [oracle documentation for function](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/RTRIM.html)
- [SQL Server documentation for function](https://learn.microsoft.com/en-us/sql/t-sql/functions/rtrim-transact-sql?view=sql-server-ver16)
- [sqlite documentation for function](https://www.sqlite.org/lang_corefunc.html#rtrim)
