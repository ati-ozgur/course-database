...
- [oracle documentation for instr](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/LTRIM.html)
- [SQL Server documentation for instr](https://learn.microsoft.com/en-us/sql/t-sql/functions/ltrim-transact-sql?view=sql-server-ver16)
- [sqlite documentation for instr](https://www.sqlite.org/lang_corefunc.html#ltrim)
