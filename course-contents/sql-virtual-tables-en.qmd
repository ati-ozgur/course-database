...
::: {.callout-warning}
Note that above sql will not work in dbeaver due to limitation of sqlite jdbc driver, see following [github xerial/sqlite-jdbc issue 1173](https://github.com/xerial/sqlite-jdbc/issues/1173).
As of November 2024
:::
